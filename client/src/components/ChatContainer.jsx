                ...
                <div className="relative">
                    ...
                    {msg.senderId === authUser._id && (
                        <button 
                            ...
                            className="absolute top-0 right-0 opacity-0 group-hover:opacity-100 transition-opacity bg-red-500 hover:bg-red-600 text-white rounded-full p-1 -mt-2 -mr-2"
