...
const ChatContainer = () => {
    ...
    const { messages, selectedUser, setSelectedUser, sendMessage, 
        getMessages, deleteMessage, isDeleting} = useContext(ChatContext)
    ...
    <div className='h-full overflow-scroll relative backdrop-blur-lg'>
      ...
      <div className='flex flex-col h-[calc(100%-120px)] overflow-y-scroll p-3 pb-6'>
        {messages.map((msg, index)=>(
            <div key={index} className={`flex items-end gap-2 justify-end ${msg.senderId !== authUser._id && 'flex-row-reverse'} group`}>
                <div className="relative">
                    ...
                    {msg.senderId === authUser._id && (
                        <button 
                            ...
                            disabled={isDeleting}
                            className="absolute top-0 right-0 opacity-0 group-hover:opacity-100 transition-opacity bg-red-500 hover:bg-red-600 disabled:bg-gray-400 text-white rounded-full p-1 -mt-2 -mr-2"
